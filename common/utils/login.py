...
class LoginUtil(object):
    def login(self, driver):
        ...
        adbUtils.input(driver, 'com.jiahe.gzb:id/corp_code_edit', 'gzb')
        driver.find_element_by_id('com.jiahe.gzb:id/next_step_btn').click()
        driver.implicitly_wait(30)
        print('识别码OK')

        # 登录
        adbUtils.input(driver, 'com.jiahe.gzb:id/input_phone_num', gobalvar.account)
        adbUtils.input(driver, 'com.jiahe.gzb:id/input_password', gobalvar.password)
