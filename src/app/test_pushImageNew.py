...
class TestTXTS:
    ...
    def isSamePic(self, driver):
        ...
        load = imageAssert.load_image("D:\\GZBAPP\\source\\Screenshot_20200125_014244_com.xfrhtx.gzb.jpg")

        # 要求误差2000以内
        result = imageAssert.same_as(load, 2000)
        return result
    ...
    def teardown(self):
        listener.listener('black_screen_report_', 'test_pushImageNew.py', 800)
        print('finished')
